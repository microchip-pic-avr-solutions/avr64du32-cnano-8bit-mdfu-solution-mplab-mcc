...
if "%2"=="" (set INPUT_IMAGE_PATH=".\dist\Standalone_xc8\production\AVR64DU32_Application.X.production.hex") else (set INPUT_IMAGE_PATH=%3\%2.X.%4.hex)
REM - relative path to client config file
set CONFIG_FILE_PATH="..\AVR64DU32_Client_Basic.X\mcc_generated_files\bootloader\configurations\bootloader_configuration.toml"
