...
if [ "$2" = "" ]; then
    INPUT_IMAGE_PATH="./dist/Standalone_xc8/production/AVR64DU32_Application_MI_ARB.X.production.hex"
else
    INPUT_IMAGE_PATH="$3/$2.X.$4.hex"
fi

# - relative path to client config file
CONFIG_FILE_PATH="../AVR64DU32_Client_MI_ARB.X/mcc_generated_files/bootloader/configurations/bootloader_configuration.toml"
